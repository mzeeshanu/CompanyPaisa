...
- **Workers' pay (2026-09-22):** the CEO pay ratio from US proxy statements (read during the SEC import), and salaries by job title from the US Department of Labor's H-1B wage filings (`--salaries`, latest two fiscal years) — see decisions log.
