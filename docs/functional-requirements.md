...
- **Coverage (2026-09-14):** every listed US company, Canadian companies that file with the SEC, and UK Main Market companies that file ESEF reports (see decisions log). UK AIM still to come.
