...
- **Coverage (2026-09-14):** every listed US company, Canadian companies that file with the SEC, UK Main Market companies, and listed companies in France, the Netherlands, Italy and Spain (financials only) — all from official filings (see decisions log). UK AIM and Germany still to come.
